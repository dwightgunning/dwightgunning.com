...
With a crew of five, we set out from Cleared Ridge at approximately 8:45am. My pack was 17kg including 5L of water; tent and sleeping gear, food and cooking equipment, and essential rain and safety gear were on board.
...
<figure class="lg:mx-32 object-contain">
  ...
  <figcaption class="text-center text-sm italic">Vegemite sandwhich. A pre-hike tradition.</figcaption>
</figure>
...
As we passed over the top of an un-named peak we crossed a literal line between sparse and dry bush into dense and notably humid rainforest. Not long after we had our first brush with gympie-gympie. Despite being flat for the next kilometer, following the trail, actually just finding a way through all the dreaded stinging nettle, became quite the challenge. That remained the case all the way through a final steep 400m stretch to Mowburra peak.
...
Maps of the area have the trail on the westerly slope but it's over to the east that a rocky clearing offers the amazing looking over Montserrat toward Mount Barney. A perfect spot for lunch and a decent rest.
...
With our slightly lighter packs we left camp with a spring in our step and early progress was good as we re-traced our way back up the dry creek bed, before turning to make a directly line to the ridge leading to Montserrat Lookout.

As soon as we left the creek and re-entered the vines and gympie-gympie, the stop-start path finding resumed. We knew we were close so it was far easier to push through to the goal. One hour for 1km. The rainforest eventually gave way to dryer eucyalptus forest covering the uppermost part of the ridgeline and we re-joined the trail leading to the lookout.
...
We dropped our packs at the intended campsite, perhaps to prove the point we had indeed arrived. Then strolled to the summit, all with a smile, to take in the views.
...
The site of the creek was a most welcomed one. At this stage we'd hiked 15km with 1200m elevation gain, and hadn't seen a water source for over 24 hours. So definitely time to refill the water bottles and treat some sore calves and tight backs to a cool swim.
