...
type: hiking
alltrails: https://www.alltrails.com/explore/recording/63def628f598c4495145c0d4-250cf8b
wikiloc: https://www.wikiloc.com/hiking-trails/multnomah-falls-and-wahkeena-falls-loop-oregon-usa-143536752
---
...
<div class="grid grid-cols-2 gap-x-4 gap-y-2 lg:mx-32 ">
  <div class="grid col-span-2 sm:col-span-1 content-center justify-center">
    <figure class="object-contain">
      <a href={fullHeightImage.src} class="open-gallery" data-image-id="fullHeight">
        <Image
          src={fullHeightImage}
  ...
  <div class="grid col-span-2 sm:col-span-1 content-center justify-center">
    <figure class="object-contain grid-cols-2">
      <a href={lowerFallsImage.src} class="open-gallery" data-image-id="lowerFalls">
        <Image
          src={lowerFallsImage}
...
<figure class="lg:mx-32 object-contain">
  <a href={lookingDownImage.src} class="open-gallery" data-image-id="lookingDown">
    <Image
...
<figure class="lg:mx-32 object-contain">
  <a href={lookingUpImage.src} class="open-gallery" data-image-id="lookingUp">
    <Image
      src={lookingUpImage}
